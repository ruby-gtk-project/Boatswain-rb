...
static void
bs_action_factory_get_property (GObject    *object,
                                guint       prop_id,
                                GValue     *value,
                                GParamSpec *pspec)
{
...
static void
bs_action_factory_set_property (GObject      *object,
                                    guint         prop_id,
                                    const GValue *value,
                                    GParamSpec   *pspec)
{
...
bs_action_factory_class_init (BsActionFactoryClass *klass)
{
  ...
  object_class->get_property = bs_action_factory_get_property;
  object_class->set_property = bs_action_factory_set_property;

  properties[PROP_CONTEXT] = g_param_spec_object ("context", NULL, NULL,
                                                  BS_TYPE_CONTEXT,
...
/**
 * bs_action_factory_get_context:
 *
 * Returns: (transfer none):
 */
BsContext *
bs_action_factory_get_context (BsActionFactory *self)
{
  BsActionFactoryPrivate *priv;

  g_return_val_if_fail (BS_IS_ACTION_FACTORY (self), NULL);

  priv = bs_action_factory_get_instance_private (self);
  return priv->context;
}
